...
クエストの内容は、「カフェで目を閉じて、コーヒーの香りが何に似ているか想像してみる」「会計の時に『ごちそうさまでした、とても美味しかったです！』と笑顔で伝えてみる」のように、具体的で実行可能なセリフや行動を提示してください。
...
プランの構成:
タイムラインの開始時間は午前6:00から8:00の間で設定してください。
